...
BUTTON_FONT = ("Raleway", 14)
TITLE_FONT = ("Raleway", 20, "bold")
...
def create_main_window():
    ...
    def show_calculation_menu():
        ...
        tk.Label(root, text="Menu Główne", font=TITLE_FONT, bg=BACKGROUND_COLOR).pack(pady=20)
        tk.Button(root, text="Przejdź do obliczeń", font=BUTTON_FONT, command=show_comparison_menu).pack(pady=10)
        tk.Button(root, text="Wyjście", font=BUTTON_FONT, command=root.quit).pack(pady=10)
    ...
    def show_comparison_menu():
        ...
        tk.Label(root, text="Wybierz opcję porównania", font=TITLE_FONT, bg=BACKGROUND_COLOR).pack(pady=20)
        tk.Button(root, text="Porównaj wskaźnik między spółkami", font=BUTTON_FONT, command=show_company_comparison_screen).pack(pady=10)
        tk.Button(root, text="Porównaj wszystkie wskaźniki w jednej spółce", font=BUTTON_FONT, command=show_all_metrics_comparison_screen).pack(pady=10)
        tk.Button(root, text="Powrót do menu głównego", font=BUTTON_FONT, command=show_calculation_menu).pack(pady=10)
    ...
    def show_company_comparison_screen():
        ...
        tk.Label(root, text="Porównaj wskaźniki między spółkami", font=TITLE_FONT, bg=BACKGROUND_COLOR).pack(pady=20)
        ...
        def add_company_row():
            ...
            tk.Label(frame, text="Spółka:", bg=BACKGROUND_COLOR, font=BUTTON_FONT).pack(side=tk.LEFT)
            tk.OptionMenu(frame, company_var, *get_companies()).pack(side=tk.LEFT)
            company_vars.append(company_var)

        add_company_row()
        tk.Button(root, text="Dodaj spółkę", font=BUTTON_FONT, command=add_company_row).pack(pady=10)

        period_frame = tk.Frame(root, bg=BACKGROUND_COLOR)
        period_frame.pack(pady=10)

        tk.Label(period_frame, text="Okres 1:", bg=BACKGROUND_COLOR, font=BUTTON_FONT).pack(side=tk.LEFT, padx=5)
        tk.OptionMenu(period_frame, period1_var, *periods).pack(side=tk.LEFT, padx=5)

        tk.Label(period_frame, text="Okres 2:", bg=BACKGROUND_COLOR, font=BUTTON_FONT).pack(side=tk.LEFT, padx=5)
        ...
        tk.Label(metric_frame, text="Wskaźnik:", bg=BACKGROUND_COLOR, font=BUTTON_FONT).pack(side=tk.LEFT, padx=5)
        ...
        tk.Button(root, text="Generuj wykres", font=BUTTON_FONT, command=generate_company_comparison_chart).pack(pady=10)
        tk.Button(root, text="Powrót", font=BUTTON_FONT, command=show_comparison_menu).pack(pady=10)
    ...
    def show_all_metrics_comparison_screen():
        ...
        tk.Label(root, text="Porównaj wszystkie wskaźniki w jednej spółce", font=TITLE_FONT, bg=BACKGROUND_COLOR).pack(pady=20)
        ...
        tk.Label(company_frame, text="Spółka:", bg=BACKGROUND_COLOR, font=BUTTON_FONT).pack(side=tk.LEFT, padx=5)
        ...
        tk.Button(root, text="Generuj wykres", font=BUTTON_FONT, command=generate_all_metrics_chart).pack(pady=10)
        tk.Button(root, text="Powrót", font=BUTTON_FONT, command=show_comparison_menu).pack(pady=10)
